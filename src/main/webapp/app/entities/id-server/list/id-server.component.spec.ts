...
describe('SampleType Management Component', () => {
  let comp: IdServerComponent;
  let fixture: ComponentFixture<IdServerComponent>;
  let service: IdServerService;
  let routerNavigateSpy: SpyInstance<Promise<boolean>>;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'sample-type', component: IdServerComponent }]), HttpClientTestingModule],
      declarations: [IdServerComponent],
      providers: [
        {
      ...
      .overrideTemplate(IdServerComponent, '')
      .compileComponents();

    fixture = TestBed.createComponent(IdServerComponent);
