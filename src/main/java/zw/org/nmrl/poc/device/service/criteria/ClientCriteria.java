...
/**
 * Criteria class for the {@link zw.org.nmrl.poc.device.domain.Client} entity. This class is used
 * in {@link zw.org.nmrl.poc.device.web.rest.ClientResource} to receive all the possible filtering options from
