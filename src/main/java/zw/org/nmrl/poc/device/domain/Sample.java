...
public class Sample implements Serializable {
	...
	public String toString() {
		return "Sample [id=" + id + ", patientId=" + patientId + ", clientSampleId=" + clientSampleId
				+ ", clientContact=" + clientContact + ", sampleTypeId=" + sampleTypeId + ", sampleTypeName="
				+ sampleTypeName + ", analysisServiceId=" + analysisServiceId + ", analysisServiceName="
				+ analysisServiceName + ", dateCollected=" + dateCollected + ", dateRegistered=" + dateRegistered
				+ ", dateTested=" + dateTested + ", result=" + result + ", unit=" + unit + ", datePublished="
				+ datePublished + ", state=" + state + ", source=" + source + "]";
	}
