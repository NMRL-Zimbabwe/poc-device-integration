...
import zw.org.nmrl.poc.device.service.ClientQueryService;
import zw.org.nmrl.poc.device.service.ClientService;
import zw.org.nmrl.poc.device.service.criteria.ClientCriteria;
import zw.org.nmrl.poc.device.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link zw.org.nmrl.poc.device.domain.Client}.
 */
@RestController
@RequestMapping("/api")
